...
def display_news_item(news_item):
    ...
    API_KEY = os.getenv('VIRUSTOTAL_API_KEY', '')  # Loaded from environment
...
def sidebar_navigation():
    ...
    options = ["Feed", "Visualization", "Cyber Mapping", "Cyber Intelligence", "Report Incident", "Threat Actors"]  # Added "Threat Actors"
...
# Visualization Dashboard with Two-Column Layout
...
def app():
    ...
    if choice == "Feed":
        ...
        json_file_path = "D:/Study/SIH 2024/CyberCrew/updated_processednew.json"
        try:
        ...
        json_file_path = r"D:/Study/SIH 2024/CyberCrew/trials/saved/processednew.json"
    ...
    if st.button("Open Dashboard in Power BI"):
        try:
            os.startfile(dashboard_path)  # Opens the file with the associated default application
